...
const ytdl = require('ytdl-milton')
const yts = require('milton-pack')
const fs = require('fs')
                    ...
                    let buttonMessage = {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                mediaType: 2,
                                mediaUrl: 'https://github.com/BlackSherif45/Milton-Md',
                                sourceUrl: 'https://github.com/BlackSherif45/Milton-Md'
                            }
                        }
                    }
