 ...
 * @project_name : 
 * @author : SamPandey001 <https://github.com/
...
cmd({
    ...
    async(Void, citel) => {
        let { data } = await axios.get('https://api.github.com/repos/BlackSherif45/Milton-Md')
...
if(!isCreator) return citel.reply(tlang().owner);
let str="*All available themes in Milton*"
str+=`1. MILTON\n2. ADAM\n3. AYANOKOJI\n4. EDITH\n5. FRIDAY\n6. GENOS\n7. GIDEON\n8. GOKU\n9. LUFFY\n10. NARUTO\n11. NEZUKO\n12. PARKER\n13. ZEROTWO\n14. Eren Jeager(Coming Soon)\n\n these are the themes of Milton Userbot.\_Reply ${prefix}setvar THEME:ZEROTWO`
