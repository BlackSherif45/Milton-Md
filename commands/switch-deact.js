 ...
 * @author : Milton <https://github.com/BlackSherif45>
 ...
 **/
 ...
 cmd({
     ...
     async(Void, citel, text,{ isCreator }) => {
         ...
         //-----------------------------------------  
         if (!citel.isGroup) return citel.reply("This feature is only used for Group.")
         if (!text) return citel.reply(`❌ Please provide me term like like\n1-events\n2-antilink\n3-nsfw\n4-cardgame\n5-bot`)
         if (!isAdmins) return citel.reply("❌ This Command is only for group Admins")
         switch (text.split(" ")[0]) {
            case 'antilink':
                {
