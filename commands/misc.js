    ...
    if (!isCreator) return citel.reply(tlang().owner)
          let Group = await sck.findOne({ id: citel.chat })
            if (!Group) {
                ...
                return citel.reply('Welcome successfully updated.')
...
let a = await getBuffer(`https://citel-x.herokuapp.com/attp/${text}`)
 return citel.reply(a,{packname:'Milton',author:'ATTP'},"sticker") 
         }
     )
 cmd({
             pattern: "ttp",
...
let a = await getBuffer(`https://citel-x.herokuapp.com/ttp/${text}`)
 return citel.reply(a,{packname:'Milton',author:'TTP'},"sticker") 
         }
     )
     //---------------------------------------------------------------------------
 cmd({
                 ...
                 default:
                     {
                         ...
                         let chatbot= await chatbot.findOne({ id: 'chatbot' })
                         await Void.sendButtonText(citel.chat, buttons, `Chatbot Status: ${chatbott.worktype} `, 'Milton-Md', citel);
